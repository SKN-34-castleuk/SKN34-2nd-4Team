...
from .models import Customer, CustomerInsight, ModelRun
...
def _recommended_action(risk_level: str, activity_gap: float, cluster_name: str) -> str:
        ...
        insight_records.append(
            {
                ...
                "recommended_action": _recommended_action(risk, gap, cluster_name),
